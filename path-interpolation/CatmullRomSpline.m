...
% Inputs:
% - [number] t (time) the relative x position of the interpolated point between the middle points (y1 and y2). It is a number in the interval [0,1], with t=0 being y=y1 and t=1 equal y2))
...
function q = CatmullRomSpline(t, y0, y1, y2, y3)
	q = 0.5 * [1 t t*t t*t*t] * [0 2 0 0; -1 0 1 0; 2 -5 4 -1; -1 3 -3 1] * [y0; y1; y2; y3];
end
